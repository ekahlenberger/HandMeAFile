...
namespace org.ek.HandMeAFile.commons.ApiWrapper.System.Net
{
    public class HttpClientWrapper : IHttpClient
    {
        ...
        {
            return m_orgHttpClient.GetAsync(requestUri, completionOption, cancellationToken);
        }
        /// <summary>
        ...
        {
            return m_orgHttpClient.GetAsync(requestUri, cancellationToken);
        }
        /// <summary>
        ...
        {
            get { return m_orgHttpClient.BaseAddress; }
            set { m_orgHttpClient.BaseAddress = value; }
        }
        private readonly HttpClient m_orgHttpClient;
        public HttpClientWrapper(HttpClient orgHttpClient)
        {
            m_orgHttpClient = orgHttpClient;
        }
    }
}
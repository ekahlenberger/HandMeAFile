...
namespace org.ek.HandMeAFile.commons.ApiWrapper.System.IO
{
    public class FileInfoWrapper : IFileInfo
    {
        ...
        {
            return m_orgInfo.GetLifetimeService();
        }
        /// <summary>
        ...
        {
            return m_orgInfo.InitializeLifetimeService();
        }
        /// <summary>
        ...
        {
            return m_orgInfo.CreateObjRef(requestedType);
        }
        /// <summary>
        ...
        public string FullName => m_orgInfo.FullName;
        /// <summary>
        ...
        /// </returns>
        public string Extension => m_orgInfo.Extension;
        /// <summary>
        ...
        {
            get { return m_orgInfo.CreationTime; }
            set { m_orgInfo.CreationTime = value; }
        }
        /// <summary>
        ...
        {
            get { return m_orgInfo.CreationTimeUtc; }
            set { m_orgInfo.CreationTimeUtc = value; }
        }
        /// <summary>
        ...
        {
            get { return m_orgInfo.LastAccessTime; }
            set { m_orgInfo.LastAccessTime = value; }
        }
        /// <summary>
        ...
        {
            get { return m_orgInfo.LastAccessTimeUtc; }
            set { m_orgInfo.LastAccessTimeUtc = value; }
        }
        /// <summary>
        ...
        {
            get { return m_orgInfo.LastWriteTime; }
            set { m_orgInfo.LastWriteTime = value; }
        }
        /// <summary>
        ...
        {
            get { return m_orgInfo.LastWriteTimeUtc; }
            set { m_orgInfo.LastWriteTimeUtc = value; }
        }
        /// <summary>
        ...
        {
            get { return m_orgInfo.Attributes; }
            set { m_orgInfo.Attributes = value; }
        }
        ...
        {
            return new FileInfoWrapper(m_orgInfo.CopyTo(destFileName));
        }
        /// <summary>
        ...
        {
            return new FileInfoWrapper(m_orgInfo.CopyTo(destFileName, overwrite));
        }
        /// <summary>
        /// Erstellt eine Datei.
        /// </summary>
        ...
        {
            return new FileStreamWrapper(m_orgInfo.Create());
        }
        /// <summary>
        ...
        {
            return new FileStreamWrapper(m_orgInfo.Open(mode));
        }
        /// <summary>
        ...
        {
            return new FileStreamWrapper(m_orgInfo.Open(mode, access));
        }
        /// <summary>
        ...
        {
            return new FileStreamWrapper(m_orgInfo.Open(mode, access, share));
        }
        /// <summary>
        ...
        {
            return new FileStreamWrapper(m_orgInfo.OpenRead());
        }
        /// <summary>
        ...
        {
            return new FileStreamWrapper(m_orgInfo.OpenWrite());
        }
        /// <summary>
        ...
        {
            return new FileInfoWrapper(m_orgInfo.Replace(destinationFileName, destinationBackupFileName));
        }
        /// <summary>
        ...
        {
            return new FileInfoWrapper(m_orgInfo.Replace(destinationFileName, destinationBackupFileName, ignoreMetadataErrors));
        }
        /// <summary>
        ...
        /// Der Name der Datei.
        /// </returns>
        public string Name => m_orgInfo.Name;
        /// <summary>
        ...
        public long Length => m_orgInfo.Length;
        /// <summary>
        ...
        public string DirectoryName => m_orgInfo.DirectoryName;
        ///// <summary>
        ///// Ruft eine Instanz des übergeordneten Verzeichnisses ab.
        ///// </summary>
        ///// <returns>
        ///// Ein <see cref="T:System.IO.DirectoryInfo"/>-Objekt, das das übergeordnete Verzeichnis dieser Datei darstellt.
        ///// </returns>
        ///// <exception cref="T:System.IO.DirectoryNotFoundException">Der angegebene Pfad ist ungültig. Dies ist z. B. der Fall, wenn das Laufwerk des Pfads nicht zugeordnet ist.</exception><exception cref="T:System.Security.SecurityException">Der Aufrufer verfügt nicht über die erforderliche Berechtigung.</exception><PermissionSet><IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true"/></PermissionSet>
        //public DirectoryInfo Directory => m_orgInfo.Directory;
        ...
        {
            get { return m_orgInfo.IsReadOnly; }
            set { m_orgInfo.IsReadOnly = value; }
        }
        /// <summary>
        ...
        /// </returns>
        public bool Exists => m_orgInfo.Exists;
        private readonly FileInfo m_orgInfo;
        public FileInfoWrapper(FileInfo orgInfo)
        {
            m_orgInfo = orgInfo;
        }
    }
